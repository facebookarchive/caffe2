...
CAFFE2_API EventWaitFunction Event::event_waiter_[MaxDeviceTypes][MaxDeviceTypes];
...
CAFFE2_API EventErrorMessageFunction Event::event_err_msg_getter_[MaxDeviceTypes];
CAFFE2_API EventSetFinishedFunction Event::event_finished_setter_[MaxDeviceTypes];
