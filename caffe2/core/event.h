...
class Event {
 ...
 private:
  ...
  CAFFE2_API static EventWaitFunction event_waiter_[MaxDeviceTypes][MaxDeviceTypes];
  ...
  CAFFE2_API static EventErrorMessageFunction event_err_msg_getter_[MaxDeviceTypes];
  CAFFE2_API static EventSetFinishedFunction event_finished_setter_[MaxDeviceTypes];
