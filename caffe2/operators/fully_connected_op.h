...
class FullyConnectedOp final : public Operator<Context> {
 public:
  ...
  template <typename T_X, typename T_W, typename T_B,
            typename T_Y, typename MATH>
  bool DoRunWithType() {
...
class FullyConnectedGradientOp : public Operator<Context> {
 public:
  ...
  template <typename T_X, typename T_W, typename T_DY, typename T_B,
            typename T_DX, typename T_DW, typename T_DB, typename MATH>
  bool DoRunWithType() {
    const auto& X = Input(0);
    const auto& W = Input(1);
