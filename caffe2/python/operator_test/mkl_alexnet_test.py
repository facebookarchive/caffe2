...
class TestAlexNet(test_util.TestCase):
    bs = 32
    layerwisetiming = False

    def testMKLAlexNet(self):
        bs = self.bs
        layerwisetiming = self.layerwisetiming
        ...
        runtime = workspace.BenchmarkNet(net.Proto().name, 10, 100, layerwisetiming)
        
    
    def testCPUAlexNet(self):
        bs = self.bs
        layerwisetiming = self.layerwisetiming
    ...
    def testCPUandMKLAlexNet(self):
        ...
        print("CPU loss {}, MKL loss {}.".format(workspace.FetchBlob("xent"), workspace.FetchBlob("xent_mkl")))
