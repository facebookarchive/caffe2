...
'''
Parallelized multi-GPU distributed trainer. Can be used to train
...
def Train(args, create_model_ops):
    '''
    Train the model.

    args:
      create_model_ops: Model building functions
    '''
...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Caffe2: training"
    )
    parser.add_argument("--net_name", type=str, required=True,
                        help="Name of the created network")
